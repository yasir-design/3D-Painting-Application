...
public class ClickPositionManager_00 : MonoBehaviour
{
    ...
    void Update()
    {
        if(Input.GetMouseButtonDown (0) | Input.GetMouseButton (1))
        {
            ...
            primitive.GetComponent<Renderer>().material.color = new Vector4(Random.Range(0.1f, 1f), Random.Range(0.1f, 1f), Random.Range(0.1f, 1f));
